...
describe("HasNone (class)", () => {
	it("HasNone (a) (class)", (done) => {
		expect(perman.none(flags_a, ["a"])).to.be.false;
		expect(perman.none(flags_a, ["b"])).to.be.true;
		expect(perman.none(flags_a, ["c"])).to.be.true;
		expect(perman.none(flags_a, ["a", "b"])).to.be.false;
		expect(perman.none(flags_a, ["a", "c"])).to.be.false;
		expect(perman.none(flags_a, ["b", "c"])).to.be.true;
		expect(perman.none(flags_a, ["a", "b", "c"])).to.be.false;

		done();
	});

	it("HasNone (ab) (class)", (done) => {
		expect(perman.none(flags_ab, ["a"])).to.be.false;
		expect(perman.none(flags_ab, ["b"])).to.be.false;
		expect(perman.none(flags_ab, ["c"])).to.be.true;
		expect(perman.none(flags_ab, ["a", "b"])).to.be.false;
		expect(perman.none(flags_ab, ["a", "c"])).to.be.false;
		expect(perman.none(flags_ab, ["b", "c"])).to.be.false;
		expect(perman.none(flags_ab, ["a", "b", "c"])).to.be.false;

		done();
	});

	it("HasNone (abc) (class)", (done) => {
		expect(perman.none(flags_abc, ["a"])).to.be.false;
		expect(perman.none(flags_abc, ["b"])).to.be.false;
		expect(perman.none(flags_abc, ["c"])).to.be.false;
		expect(perman.none(flags_abc, ["a", "b"])).to.be.false;
		expect(perman.none(flags_abc, ["a", "c"])).to.be.false;
		expect(perman.none(flags_abc, ["b", "c"])).to.be.false;
		expect(perman.none(flags_abc, ["a", "b", "c"])).to.be.false;

		done();
	});

	it("HasNone (full) (class)", (done) => {
		expect(perman.none(flags_full, ["a"])).to.be.false;
		expect(perman.none(flags_full, ["b"])).to.be.false;
		expect(perman.none(flags_full, ["c"])).to.be.false;
		expect(perman.none(flags_full, ["a", "b"])).to.be.false;
		expect(perman.none(flags_full, ["a", "c"])).to.be.false;
		expect(perman.none(flags_full, ["b", "c"])).to.be.false;
		expect(perman.none(flags_full, ["a", "b", "c"])).to.be.false;

		done();
	});

	it("HasNone (empty) (class)", (done) => {
		expect(perman.none(flags_empty, ["a"])).to.be.true;
		expect(perman.none(flags_empty, ["b"])).to.be.true;
		expect(perman.none(flags_empty, ["c"])).to.be.true;
		expect(perman.none(flags_empty, ["a", "b"])).to.be.true;
		expect(perman.none(flags_empty, ["a", "c"])).to.be.true;
		expect(perman.none(flags_empty, ["b", "c"])).to.be.true;
		expect(perman.none(flags_empty, ["a", "b", "c"])).to.be.true;

		done();
	});

	it("HasNone (unknown) (class)", (done) => {
		expect(perman.none(flags_unknown, ["a"])).to.be.true;
		expect(perman.none(flags_unknown, ["b"])).to.be.true;
		expect(perman.none(flags_unknown, ["c"])).to.be.true;
		expect(perman.none(flags_unknown, ["a", "b"])).to.be.true;
		expect(perman.none(flags_unknown, ["a", "c"])).to.be.true;
		expect(perman.none(flags_unknown, ["b", "c"])).to.be.true;
		expect(perman.none(flags_unknown, ["a", "b", "c"])).to.be.true;

		done();
	});
});

describe("HasNone (with empty array) (class)", () => {
	it("HasNone (with empty array) (a) (class)", (done) => {
		expect(perman.none(flags_a, [])).to.be.true;

		done();
	});

	it("HasNone (with empty array) (ab) (class)", (done) => {
		expect(perman.none(flags_ab, [])).to.be.true;

		done();
	});

	it("HasNone (with empty array) (abc) (class)", (done) => {
		expect(perman.none(flags_abc, [])).to.be.true;

		done();
	});

	it("HasNone (with empty array) (full) (class)", (done) => {
		expect(perman.none(flags_full, [])).to.be.true;

		done();
	});

	it("HasNone (with empty array) (empty) (class)", (done) => {
		expect(perman.none(flags_empty, [])).to.be.true;

		done();
	});

	it("HasNone (with empty array) (unknown) (class)", (done) => {
		expect(perman.none(flags_unknown, [])).to.be.true;
